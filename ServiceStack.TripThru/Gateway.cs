...
namespace TripThru.Gateway
{
	...
	public class Zone
	{
		...
		{
			return Math.Pow(l.lng - l.lat, 2) + Math.Pow(center.lng - center.lat, 2) < Math.Pow(radius, 2);
		}
	...
	public class Location
	{
		...
		public Location(double lat, double lng, string name = null)
		{
			...
			this.lat = lat;
			if (name == null)
				this.name = "\"" + GeoLocation.ReverseGeoLoc(lng.ToString(), lat.ToString()) + "\"";
			else
				this.name = "\"" + name + "\"";
		}
	...
	public class Gateway
	{
		...
		public class QuoteTrip
		{
			...
			public class Response
			{
				...
				public override string ToString()
				{
					return quotes.Count + " Quotes, Result = " + result;
				}
			}

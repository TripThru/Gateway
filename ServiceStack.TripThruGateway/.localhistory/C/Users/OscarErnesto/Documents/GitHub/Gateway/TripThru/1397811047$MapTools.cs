...
namespace Utils
{
    ...
    public class MapTools
    {
        ...
        private static IEnumerable<Waypoint> IncreaseGranularityDistance(int duration, int maxDuration, double totalDuration, double distance, double totalDistance, Location from, Location to)
        {

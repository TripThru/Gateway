...
namespace TripThruSsh
{
    class Program
    {
        ...
        private static void UploadProjects()
        {
            ...
            ssh.RunCommand("mkdir -p " + "/var/www/" + "ServiceStack.Mvc3");
            ssh.RunCommand("mkdir -p " + "/var/www/" + "ServiceStack.Mvc4");
            ...
            UploadDirectory(localPath + "Mvc3", "/var/www/" + "ServiceStack.Mvc3");
            UploadDirectory(localPath + "Mvc4", "/var/www/" + "ServiceStack.Mvc4");
        ...
        private static void UpdateMonoConfiguration()
        {
            ...
            webappConfig.WriteLine(@"<web-application>
                                    <name>ServiceStack.Mvc3</name>
                                    <vhost>*</vhost>
                                    <vport>80</vport>
                                    <vpath>/ServiceStack.Mvc3</vpath>
                                    <path>/var/www/ServiceStack.Mvc3</path>
                                 </web-application>"
                );
            webappConfig.Flush();

            webappConfig.WriteLine(@"<web-application>
                                    <name>ServiceStack.Mvc4</name>
                                    <vhost>*</vhost>
                                    <vport>80</vport>
                                    <vpath>/ServiceStack.Mvc4</vpath>
                                    <path>/var/www/ServiceStack.Mvc4</path>
                                 </web-application>"
                );
            webappConfig.Flush();

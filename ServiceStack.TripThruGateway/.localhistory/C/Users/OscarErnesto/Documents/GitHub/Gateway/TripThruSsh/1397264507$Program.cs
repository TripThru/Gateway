...
namespace TripThruSsh
{
    class Program
    {
        ...
        private static void UploadProjects()
        {
            ...
            ssh.RunCommand("mkdir -p " + remoteFilePath + "Mvc3");
            ssh.RunCommand("mkdir -p " + remoteFilePath + "Mvc4");
            ...
            UploadDirectory(localPath + "Mvc3", remoteFilePath + "Mvc3");
            UploadDirectory(localPath + "Mvc4", remoteFilePath + "Mvc4");

...
namespace Utils
{
    ...
    public class Waypoint : Location
    {
        ...
        public TimeSpan elapse
        {
            ...
            set { _elapseTimeSpan = new TimeSpan(0, 0, (int)value.TotalSeconds); }
        }
    ...
    public class Route
    {
        ...
        public TimeSpan duration { get { return waypoints[waypoints.Length - 1].elapse; } set { this.duration = new TimeSpan(0, 0, (int)value.TotalSeconds);  } }

...
namespace TripThruGenerateFilesOfRoutes
{
    class Program
    {
        private static IEnumerable<Location> IncreaseGranularityDistance(Location from, Location to, double maxLatLng)
        {
            ...
            {
                var repeatTimes = (uint)(result / maxLatLng) + 1; //Obtenemos las veces que se repetira el proceso.
        ...
        static void Main()
        {
            ...
            var locations = IncreaseGranularityDistance(fromLocation, toLocation, 0.001);

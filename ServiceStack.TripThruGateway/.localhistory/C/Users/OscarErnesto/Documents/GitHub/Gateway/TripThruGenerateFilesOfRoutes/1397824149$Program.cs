...
namespace TripThruGenerateFilesOfRoutes
{
    class Program
    {
        ...
        private static IEnumerable<Waypoint> IncreaseLocationsEnumerable(IEnumerable<Location> locations, double duration, int maxDuration, double totalDuration, double distance, double totalDistance)
        {

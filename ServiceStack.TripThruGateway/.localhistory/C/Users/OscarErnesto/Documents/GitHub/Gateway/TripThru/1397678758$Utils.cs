...
namespace Utils
{
    ...
    public class Waypoint : Location
    {
        ...
        public Waypoint(double lat, double lng, double elapse, double distance, string name = null)
            : base(lat, lng, name)
        {
            this.elapseSeconds = elapse;
            this.distance = distance;
        }
        public Waypoint(Location l, double elapse, double distance, string name = null)
    ...
    public class Route
    {
        ...
        public TimeSpan duration
        {
            get
            {
                double seconds = waypoints[waypoints.Length - 1].elapseSeconds;
        ...
        public Location GetCurrentWaypoint(DateTime start, DateTime current)
        {
            ...
            int waypoint;
            for (waypoint = 0; elapse > new TimeSpan(0, 0, (int)waypoints[waypoint].elapseSeconds) && waypoint < waypoints.Length - 1; waypoint++) ;

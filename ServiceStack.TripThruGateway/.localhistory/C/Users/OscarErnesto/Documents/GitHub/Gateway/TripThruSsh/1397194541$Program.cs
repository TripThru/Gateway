...
namespace TripThruSsh
{
    class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            Logger.Tab();
            Logger.Log("Test Tab Log 1");
            Logger.Log("Test Tab Log 2");
            Logger.Untab();
            Logger.Log("Test Log 4");
            Logger.Log("Test Log 5");
            Logger.Log("Test Log 6");
            Logger.Log("Test Log 7");
            Logger.Log("Test Log 8");
            Logger.AddTag("Test","Test2");

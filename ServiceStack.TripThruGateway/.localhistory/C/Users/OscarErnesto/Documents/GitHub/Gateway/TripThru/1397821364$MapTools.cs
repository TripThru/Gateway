...
namespace Utils
{
    ...
    public class MapTools
    {
        ...
        private static IEnumerable<Waypoint> IncreaseLocationsEnumerable(IEnumerable<Location> locations, int duration, int maxDuration, double totalDuration, double distance, double totalDistance)
        {
            ...
            int stepDuration = duration/maxDuration;
            double stepDistance = distance/stepDuration;
            ...
            foreach (var location in locations)
            {
                ...
                var stepDurationTemp = stepDuration/tempLocations.Count();
                var stepDistanceTemp = stepDistance/tempLocations.Count();
                var countDurationTemp = countDuration;
                var countDistanceTemp = countDistance;

                foreach (var tempLocation1 in tempLocations)
                {
                    wayPoints.Add(new Waypoint(location,new TimeSpan(0,0,(int)countDurationTemp),countDistanceTemp ));
                }
            }

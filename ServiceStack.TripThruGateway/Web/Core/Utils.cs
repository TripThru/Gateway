...
namespace Utils
{
    ...
    public class MapTools
    {
        ...
        public static void LoadGeoData(string filenameLocationNames, string filenameRoutes)
        {
        ...
        public static void WriteGeoData(string filenameLocationNames, string filenameRoutes)
        {
            using (CsvFileWriter writer = new CsvFileWriter(filenameRoutes))
            {
                int routeID = 0;
            ...
            using (CsvFileWriter writer = new CsvFileWriter(filenameLocationNames))
            {

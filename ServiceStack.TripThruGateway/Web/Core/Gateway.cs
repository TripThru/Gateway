...
namespace ServiceStack.TripThruGateway
{
    ...
    public class Gateway
    {
        ...
        public delegate GatewayClient GetGatewayClientDelegate(string accessToken, string urlCallback);
        public GetGatewayClientDelegate GetClientGateway; 

        public Gateway(GetGatewayClientDelegate getClientGateway)
        {
            this.GetClientGateway = getClientGateway;
            exceptions = new Stat();
            rejects = new Stat();
            requests = new Stat();
            cancels = new Stat();

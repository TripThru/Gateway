...
namespace ServiceStack.TripThruPartnerGateway
{
    public class Partner : Gateway
    {
        ...
        public Partner(GetGatewayClientDelegate getClientGateway, string name, string clientId, string accessToken, string tripthruURL, List<PartnerFleet> PartnerFleets = null)
            : base(getClientGateway)
        {
            this.tripthru = getClientGateway(accessToken, tripthruURL);
            this.ID = clientId;
            this.name = name;
